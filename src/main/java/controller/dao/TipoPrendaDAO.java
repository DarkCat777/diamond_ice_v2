...
public class TipoPrendaDAO extends AbstractDAO<Long, TipoPrenda> {
    /**
     ...
     */
    @Override
    public List<TipoPrenda> getAll() throws HibernateUtilException, DataAccessObjectException {
        List<TipoPrenda> tipoPrendas;
        ...
        try {
            ...
            tipoPrendas = (List<TipoPrenda>) entityManager.createQuery("FROM TipoPrenda ").getResultList();
     ...
     */
    @Override
    public TipoPrenda get(Long aLong) throws HibernateUtilException, DataAccessObjectException {
        ...
        if (aLong == null) {
            ...
            try {
                entityManager = HibernateUtil.getSessionFactory().getCurrentSession().getEntityManagerFactory().createEntityManager();
                tipoPrenda = entityManager.find(TipoPrenda.class, aLong);
            } catch (HibernateException he) {
